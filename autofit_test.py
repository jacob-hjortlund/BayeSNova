...
def main():
    ...
    dataset ='pantheon_full_fiducial_volume_limited' #'pantheon_hubble_flow'#
    name = "baseline_duplicats_log_integral_v3"
    ...
    data_path = f"/home/jacob/Uni/Msc/Thesis/Msc_Thesis/src/data/{dataset}/{dataset}.dat"
    data = pd.read_csv(data_path, sep=" ")

    volumetric_rates_path = "/home/jacob/Uni/Msc/Thesis/Msc_Thesis/src/data/volumetric_rates.dat"
    ...
    progenitor_model.cosmology.Om0 = sn_pop_1.cosmology.Om0
    progenitor_model.cosmology.w0 = sn_pop_1.cosmology.w0
    ...
    model = sn_model #sn_and_host_model
